...
$(document).ready(function(){
    ...
    //输出各选手信息
    $('#votesum1').html("<p>赖依蓝</p><p>111</p><small>票</small>");
    $('#votesum2').html("<p>蔡泽栋</p><p>222</p><small>票</small>");
    $('#votesum3').html("<p>吴泳龙</p><p>333</p><small>票</small>");
    $('#votesum4').html("<p>唐泽锐</p><p>444</p><small>票</small>");
    $('#votesum5').html("<p>陈昊恒</p><p>555</p><small>票</small>");
    $('#votesum6').html("<p>ice组合</p><p>666</p><small>票</small>");
    $('#votesum7').html("<p>李晟宇</p><p>777</p><small>票</small>");
    $('#votesum8').html("<p>刘迪嘉</p><p>888</p><small>票</small>");
    $('#votesum9').html("<p>黄巍</p><p>999</p><small>票</small>");
    $('#votesum10').html("<p>许真源</p><p>1111</p><small>票</small>");
    ...
    $('#singer1').click(function(){
        ...
        $('#getvote').html("<p>获得票数:<strong>111</strong><small>票</small></p>");
     ...
     $('#singer2').click(function(){
        ...
        all.style.display="none";
         ...
         $('#getvote').html("<p>获得票数:<strong>222</strong><small>票</small></p>");
    ...
    $('#singer3').click(function(){
        ...
        $('#getvote').html("<p>获得票数:<strong>333</strong><small>票</small></p>");
    ...
    $('#singer4').click(function(){
        ...
        $('#getvote').html("<p>获得票数:<strong>444</strong><small>票</small></p>");
    ...
    $('#singer5').click(function(){
        ...
        $('#getvote').html("<p>获得票数:<strong>555</strong><small>票</small></p>");
    ...
    $('#singer6').click(function(){
        ...
        $('#getvote').html("<p>获得票数:<strong>666</strong><small>票</small></p>");
    ...
    $('#singer7').click(function(){
        ...
        $('#getvote').html("<p>获得票数:<strong>777</strong><small>票</small></p>");
    ...
    $('#singer8').click(function(){
        ...
        $('#getvote').html("<p>获得票数:<strong>888</strong><small>票</small></p>");
    ...
    $('#singer9').click(function(){
        ...
        $('#getvote').html("<p>获得票数:<strong>999</strong><small>票</small></p>");
    ...
    $('#singer10').click(function(){
        ...
        $('#getvote').html("<p>获得票数:<strong>1111</strong><small>票</small></p>");
